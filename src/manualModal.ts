    ...
    ? [
        ...
        },
        {
          ...
          items: [
            ...
            '神經項圈監視：市民需每 100 步於任一終端機完成簽到（[T] 接入或輸入 CHECKIN），逾期未簽將觸發全域警報引來機器人圍剿！',
            '秘技測試：[ V ] 破除全圖視野限制（全知透鏡）  |  [ X ] 完整呈現小地圖測繪藍圖  |  [ 0 / F10 ] 切換解析度',
          ],
        },
      ]
    : [
        ...
        },
        {
          ...
          items: [
            ...
            'Neural Collar Surveillance: Citizens must check in at any terminal every 100 steps ([T] or CHECKIN). Overdue check-in triggers full alarm & robot assault!',
            'Testing & Display: [ V ] Toggle Omni-Vision | [ X ] Toggle Full Minimap Blueprint | [ 0 / F10 ] Cycle Resolution',
          ],
        },
      ];
